...
from classifier.engine import train_engine
...
def main(configure_path : str, device : int =  1):
    ...
    # Train the model
    train_engine(args, model, train_dataloader, val_dataloader, criterion, optimizer)
...
if __name__ == "__main__":
    ...
    config = os.path.join(config_path,'train.yaml')

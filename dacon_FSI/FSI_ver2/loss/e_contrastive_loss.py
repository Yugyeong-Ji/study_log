...
class EuclideanContrastiveLoss(nn.Module):
    ...
    def forward(self, tokens, labels):
        ...
        # Shape of tokens: (batch_size, embedding_dim)
        # Subtracting every vector from each other (broadcasting)
        ...
        # Scale distances by temperature (optional, typically used in cosine-based methods)
